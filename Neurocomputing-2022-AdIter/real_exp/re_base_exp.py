...
def exp_realworld(path, dataset_name, num_run, exp_function, **exp_parm):
    ...
    for r_seed in range(0, num_run):
        ...
        np.savetxt(str(dataset_name)+'_base_'+str(r_seed)+'.out', result , delimiter=',')
...
if __name__ == '__main__': 
    ...
    path = '/Realworld Data/'
    num_run = 30
    datasets = ['usenet1', 'usenet2', 'weather', 'spam_corpus_x2_feature_selected', 'elecNorm', 'airline']
    chunk_size = [40, 40, 365, 100, 100, 100]
